...
for L2 in langs:
    ...
    for score_type in score_types:
        ...
        scores = compute_scores_optimized_phi4(model, tokenizer, device, monolingual_sentences, candidates, centroids, score_type) # for en only.
        ...
        # save as pkl.
        sorted_neurons_path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/phi4/final_scores/reverse/{score_type}/{L2}_sorted_neurons.pkl"
        score_dict_path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/phi4/final_scores/reverse/{score_type}/{L2}_score_dict.pkl"
