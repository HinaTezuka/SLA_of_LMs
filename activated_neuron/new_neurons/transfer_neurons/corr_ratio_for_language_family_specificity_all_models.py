...
for model_type in model_types:
    for L2 in langs:
        for score_type in score_types:
            ...
            if L2 in ['nl', 'it']:
                labels_list = l2 + l1 + copy.deepcopy(l2) + copy.deepcopy(l1) + copy.deepcopy(l1) # nl, it, en = label1, others = label0
            elif L2 in ['ja', 'ko']:
                labels_list = l1 + copy.deepcopy(l2) + copy.deepcopy(l1) + copy.deepcopy(l2) + copy.deepcopy(l2) # ja, ko = label1, others = label0
