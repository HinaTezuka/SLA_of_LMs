...
for L2 in model_langs:
    ...
    for is_last_token_only in is_last_token_onlys:
        ...
        if not is_last_token_only:
            save_path_sorted_neurons = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/llama3/bilingual/ap_lang_specific/sorted_neurons_{L2}.pkl"
            save_path_ap_scores = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/llama3/bilingual/ap_lang_specific/ap_scores_{L2}.pkl"
            ...
            save_path_ap_scores = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/llama3/bilingual/ap_lang_specific/ap_scores_{L2}_last_token.pkl"
