...
for L2 in langs:
    ...
    c_path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/bloom/centroids/c_train_{L2}.pkl"
    ...
    for score_type in score_types:
        ...
        scores = compute_scores_optimized_bloom(model, tokenizer, device, monolingual_sentences, candidates, centroids, score_type) # for en only.
        ...
        # save as pkl.
        sorted_neurons_path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/bloom/final_scores/reverse/{score_type}/{L2}_sorted_neurons.pkl"
        score_dict_path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/bloom/final_scores/reverse/{score_type}/{L2}_score_dict.pkl"
