...
if __name__ == "__main__":
    ...
    result_AP = eval_BLiMP_with_edit_activation(model, model_name, tokenizer, sorted_neurons_AP)
    ...
    # save as csv
    df_main.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/AUC/blimp/AP/{dir_path}/en_{L2}.csv", index=False)
    ...
    df_shared_non_translation.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/AUC/blimp/non_translation/{dir_path}/en_{L2}.csv", index=False)
    ...
    df_comp_L1_or_L2.to_csv(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/intervention/csv/llama3/AUC/blimp/L1_or_L2/{dir_path}/en_{L2}.csv", index=False)
