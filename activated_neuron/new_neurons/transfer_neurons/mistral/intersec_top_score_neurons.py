...
for score_type in score_types:
    # top score neurons
    # ja
    ja_save_path_sorted_neurons = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/mistral/final_scores/{score_type}/ja_revised.pkl"
    ja_sorted_neurons = unfreeze_pickle(ja_save_path_sorted_neurons)[:top_n]
    nl_save_path_sorted_neurons = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/mistral/final_scores/{score_type}/nl_revised.pkl"
    nl_sorted_neurons = unfreeze_pickle(nl_save_path_sorted_neurons)[:top_n]
    ko_save_path_sorted_neurons = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/mistral/final_scores/{score_type}/ko_revised.pkl"
    ko_sorted_neurons = unfreeze_pickle(ko_save_path_sorted_neurons)[:top_n]
    it_save_path_sorted_neurons = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/pickles/transfer_neurons/mistral/final_scores/{score_type}/it_revised.pkl"
