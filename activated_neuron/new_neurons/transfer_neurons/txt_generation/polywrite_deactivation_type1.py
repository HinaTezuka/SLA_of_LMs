    ...
    for model_name in model_names:
        ...
        for L2 in langs:
            for intervention_num in deactivation_nums:
                ...
                path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/transfer_neurons/txt_generation/results/type1/{model_name_for_saving}_{L2}_intervention{intervention_num}.json' if not is_baseline else f'/home/s2410121/proj_LA/activated_neuron/new_neurons/transfer_neurons/txt_generation/results/type1/{model_name_for_saving}_{L2}_intervention{intervention_num}_baseline.json'
