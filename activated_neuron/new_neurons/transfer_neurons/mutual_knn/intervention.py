...
for is_reverse in is_reverses:
    ...
    for model_type in model_types:
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.legend(title='L2', fontsize=20, title_fontsize=20)
        
        if not is_reverse:
            save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/mutual_knn/test/{model_type}_top{topk}_type1_n{intervention_num}'
        elif is_reverse:
            save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/mutual_knn/test/{model_type}_top{topk}_type2_n{intervention_num}'
