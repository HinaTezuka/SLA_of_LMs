...
if __name__ == "__main__":
    ...
    for L2, model_name in model_names.items():
        ...
        # plot_hist(final_results_same_semantics, final_results_non_same_semantics, L2, "act_freq", "same_semantics")
        ...
        for layer_idx in range(32): # ３２ layers
            final_results_same_semantics[layer_idx] = np.array(similarities_same_semantics[layer_idx]).mean()
            final_results_non_same_semantics[layer_idx] = np.array(similarities_non_same_semantics[layer_idx]).mean()
        plot_hist(final_results_same_semantics, final_results_non_same_semantics, L2, "act_freq", "same_semantics_including_overlap_non_same_semantics")
        ...
        for layer_idx in range(32):
            final_results_same_semantics[layer_idx] = np.array(similarities_same_semantics[layer_idx]).mean()
            final_results_non_same_semantics[layer_idx] = np.array(similarities_non_same_semantics[layer_idx]).mean()
        plot_hist(final_results_same_semantics, final_results_non_same_semantics, L2, "act_freq", "non_same_semantics")
