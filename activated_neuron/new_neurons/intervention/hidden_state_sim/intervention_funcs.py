...
# visualization
def plot_hist(dict1: defaultdict(float), dict2: defaultdict(float), L2: str, folder1:str, folder2: str) -> None:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"/home/s2410121/proj_LA/activated_neuron/new_neurons/images/hidden_state_sim/intervention/llama3/{folder1}/{folder2}/en_{L2}.png")
    plt.close()
