...
score_type = 'cos_sim'
intervention_nums = [1000, 3000, 5000, 1000]
qa_num = 100
    ...
    for is_reverse in is_reverses:
        for score_type in score_types:
            for L2 in langs:
                ...
                for intervention_num in intervention_nums:
                    ...
                    for layer_i in range(layer_num):
                        if score_type == "cos_sim" and is_reverse == "normal":
                            ...
                            lang_stats_normal[layer_i][L2] = int(np.mean(ratio_L2[layer_i, :]))
                            ...
                            lang_stats_intervention[layer_i][L2] = int(np.mean(ratio_L2[layer_i, :]))
                            ...
                            lang_stats_baseline[layer_i][L2] = int(np.mean(ratio_L2_baseline[layer_i, :]))
