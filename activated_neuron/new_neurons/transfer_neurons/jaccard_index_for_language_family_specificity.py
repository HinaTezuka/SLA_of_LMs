...
for score_type in score_types:
    ...
    ja_sorted_neurons = [neuron for neuron in ja_sorted_neurons if neuron[0] in [ _ for _ in range(20, 32)]] if model_type in ['llama3', 'mistral', 'aya'] else [neuron for neuron in ja_sorted_neurons if neuron[0] in [ _ for _ in range(20, 30)]]
    ...
    nl_sorted_neurons = [neuron for neuron in nl_sorted_neurons if neuron[0] in [ _ for _ in range(20, 32)]] if model_type in ['llama3', 'mistral', 'aya'] else [neuron for neuron in nl_sorted_neurons if neuron[0] in [ _ for _ in range(20, 30)]]
    ...
    ko_sorted_neurons = [neuron for neuron in ko_sorted_neurons if neuron[0] in [ _ for _ in range(20, 32)]] if model_type in ['llama3', 'mistral', 'aya'] else [neuron for neuron in ko_sorted_neurons if neuron[0] in [ _ for _ in range(20, 30)]]
    ...
    it_sorted_neurons = [neuron for neuron in it_sorted_neurons if neuron[0] in [ _ for _ in range(20, 32)]] if model_type in ['llama3', 'mistral', 'aya'] else [neuron for neuron in it_sorted_neurons if neuron[0] in [ _ for _ in range(20, 30)]]
