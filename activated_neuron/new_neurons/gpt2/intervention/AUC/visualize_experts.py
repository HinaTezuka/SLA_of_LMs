...
for L2 in L2_list:
    ...
    if model == "llama":
        save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/same_semantic_experts/{activation_type}/{L2}.png'
    elif model == "gpt2":
        save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/same_semantic_experts/{activation_type}/{L2}_gpt2.png'
