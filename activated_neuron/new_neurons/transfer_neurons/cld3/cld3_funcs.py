...
def plot_lang_distribution(lang_distribution, score_type: str, model_name: str, intervention_num: int, L2: str, is_reverse:bool=False, is_baseline:bool=False, L1="en"):
    ...
    if score_type == "normal":
        save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/cld3/{model_name}/{score_type}/{L2}.png'
    else:
        if not is_baseline:
            if not is_reverse:
                save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/cld3/{model_name}/{score_type}/{L2}_n{intervention_num}.png'
            elif is_reverse:
                save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/cld3/{model_name}/{score_type}/reverse/{L2}_n{intervention_num}.png'
        elif is_baseline:
            if not is_reverse:
                save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/cld3/{model_name}/{score_type}/{L2}_n{intervention_num}_baseline.png'
            elif is_reverse:
                save_path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/cld3/{model_name}/{score_type}/reverse/{L2}_n{intervention_num}_baseline.png'
