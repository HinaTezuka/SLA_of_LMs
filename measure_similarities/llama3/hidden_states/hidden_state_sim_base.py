...
def plot_hist(dict1: defaultdict(float), dict2: defaultdict(float), L2: str) -> None:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"/home/s2410121/proj_LA/measure_similarities/llama3/images/hidden_state_sim/normalized/base/llama3_hidden_state_sim_en_{L2}.png")
    plt.close()
...
def plot_hist_L2(dict1: defaultdict(float), dict2: defaultdict(float), L2: str) -> None:
    ...
    plt.title('L2 distance between translation pairs and non translation pairs')
    plt.legend()
    plt.grid(True)
    plt.savefig(f"/home/s2410121/proj_LA/measure_similarities/llama3/images/hidden_state_sim/L2_dist/normalized/base/llama3_hidden_state_sim_en_{L2}.png")
    plt.close()
