...
for model in models:
    for L2 in L2_list:
        ...
        if not is_last_token_only:
            path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/distribution/{model}/lang_specific/{L2}.png'
        elif is_last_token_only:
            path = f'/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/distribution/{model}/lang_specific/{L2}_last_token.png'
