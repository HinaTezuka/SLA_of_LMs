...
# shared_ONLY <- 同じ意味表現（対訳ペア）にのみ、発火している shared neurons
pkl_file_path = f"/home/s2410121/proj_LA/activated_neuron/gpt2/pickles/tatoeba_0_th/shared_ONLY/shared_ONLY_dict_en_{L2}_tatoeba_0_th.pkl"
