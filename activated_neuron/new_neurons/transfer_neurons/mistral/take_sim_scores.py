...
def plot_hist_llama3(dict1: defaultdict(float), dict2: defaultdict(float), L2: str, score_type: str, intervention_num: str, is_en=False, is_baseline=False) -> None:
    ...
    if is_en:
        if not is_baseline:
            path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/sim/{model_type}/final/{score_type}/en/{L2}_n{intervention_num}.png"
        elif is_baseline:
            path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/sim/{model_type}/final/{score_type}/en/baseline/{L2}_n{intervention_num}.png"
    elif not is_en:
        if not is_baseline:
            path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/sim/{model_type}/final/{score_type}/{L2}_n{intervention_num}.png"
            # path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/sim/{model_type}/final/{score_type}/reverse/{L2}_n{intervention_num}.png"
        elif is_baseline:
            path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/sim/{model_type}/final/{score_type}/baseline/{L2}_n{intervention_num}.png"
            # path = f"/home/s2410121/proj_LA/activated_neuron/new_neurons/images/transfers/sim/{model_type}/final/{score_type}/reverse/baseline/{L2}_n{intervention_num}.png"
    # plt.savefig(
    #     path,
    #     bbox_inches="tight"
    # )
